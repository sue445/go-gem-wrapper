...
module RubyHeaderParser
  ...
  class Parser # rubocop:disable Metrics/ClassLength
    ...
    def initialize(header_file: "#{RbConfig::CONFIG["rubyhdrdir"]}/ruby.h", 
include_paths: [RbConfig::CONFIG["rubyarchhdrdir"], RbConfig::CONFIG["rubyhdrdir"]], dist_preprocessed_header_file:)
