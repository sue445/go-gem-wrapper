...
//export rb_dummy_tests_nop_rb_define_method_id
func rb_dummy_tests_nop_rb_define_method_id(_ C.VALUE) {
}
...
//export rb_dummy_tests_rb_ary_pop
func rb_dummy_tests_rb_ary_pop(_ C.VALUE, ary C.VALUE) C.VALUE {
	ret := ruby.RbAryPop(ruby.VALUE(ary))

	return C.VALUE(ret)
}

//export rb_dummy_tests_rb_ary_shift
func rb_dummy_tests_rb_ary_shift(_ C.VALUE, ary C.VALUE) C.VALUE {
	ret := ruby.RbAryShift(ruby.VALUE(ary))

	return C.VALUE(ret)
}

//export rb_dummy_tests_rb_ary_unshift
func rb_dummy_tests_rb_ary_unshift(_ C.VALUE, ary C.VALUE, elem C.VALUE) C.VALUE {
